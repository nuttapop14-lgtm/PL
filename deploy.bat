...
call firebase deploy --only hosting --project pl26-27

if %errorlevel% neq 0 (
    echo.
    echo ⚠️ บัญชีปัจจุบันไม่มีสิทธิ์เข้าถึงโปรเจกต์ pl26-27
    echo 🌐 กำลังเปิดเบราว์เซอร์เพื่อเข้าสู่ระบบบัญชี Google ของโปรเจกต์ pl26-27...
    echo.
